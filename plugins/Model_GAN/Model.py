...
class Model():
    ...
    def load(self, swapped):
        try:
            ...
            self.decoder_A.load_weights(self.model_dir + decoder_AH5)
            self.decoder_B.load_weights(self.model_dir + decoder_BH5)
            self.netDA.load_weights(self.model_dir + netDAH5)
            self.netDB.load_weights(self.model_dir + netDBH5)
